                        ...
                        <div class="my-2 d-flex align-items-center justify-content-between">
                            ...
                            <div class="">
                                <img src="{{ asset('manager/images/cards/american-express.svg') }}" alt="user-card"
                                    height="36" />
                                <img src="{{ asset('manager/images/cards/discover-card.svg') }}" alt="user-card"
                                    height="36" />
                                <img src="{{ asset('manager/images/cards/mastercard.svg') }}" alt="user-card"
                                    height="36" />
                            </div>
                        </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/products/logo/logo-1.svg') }}"
                                                            alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-info-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/products/logo/logo-2.svg') }}"
                                                            alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/products/logo/logo-3.svg') }}"
                                                            alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-danger-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/products/logo/logo-4.svg') }}"
                                                            alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-success-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/products/logo/logo-5.svg') }}"
                                                            alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/users/avatar-1.jpg') }}"
                                                            alt="" height="22" class="rounded-circle">
                                                    </span>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-info-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/users/avatar-2.jpg') }}"
                                                            alt="" height="22" class="rounded-circle">
                                                    </span>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/users/avatar-3.jpg') }}"
                                                            alt="" height="22" class="rounded-circle">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-warning-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/users/avatar-4.jpg') }}"
                                                            alt="" height="22" class="rounded-circle">
                                                    </span>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-danger-subtle rounded-circle">
                                                        <img src="{{ asset('manager/images/users/avatar-5.jpg') }}"
                                                            alt="" height="22" class="rounded-circle">
                                                    </span>
                                                </div>
                                                <div>
                            ...
                            <div class="col-xl-5" dir="ltr">
                                <div class="p-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1"><img src="{{ asset('manager/images/flags/us.svg') }}"
                                                alt="user-image" class="me-1 rounded-circle" height="20"> <span
                                    ...
                                    <!-- Country Data -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1"><img src="{{ asset('manager/images/flags/in.svg') }}"
                                                alt="user-image" class="me-1 rounded-circle" height="20"> <span
                                    ...
                                    <!-- Country Data -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1"><img src="{{ asset('manager/images/flags/br.svg') }}"
                                                alt="user-image" class="me-1 rounded-circle" height="20"> <span
                                    ...
                                    <!-- Country Data -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-1"><img src="{{ asset('manager/images/flags/ca.svg') }}"
                                                alt="user-image" class="me-1 rounded-circle" height="20"> <span
