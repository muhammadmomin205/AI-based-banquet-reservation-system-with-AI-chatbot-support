        ...
        <section id="travel-hero" class="travel-hero section dark-background">
            ...
            <div class="hero-background">
                <video autoplay="" muted="" loop="">
                    <source src="{{ asset('customer/img/travel/video-2.mp4') }}" type="video/mp4">
                </video>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="hero-text" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <p class="hero-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                        <div class="about-image">
                            <img src="{{ asset('customer/img/travel/showcase-8.webp') }}" alt="Travel Experience"
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="featured-destination">
                            <div class="destination-overlay">
                                <img src="{{ asset('customer/img/travel/destination-3.webp') }}" alt="Tropical Paradise"
                                    class="img-fluid">
                                <div class="destination-info">
                                    ...
                                    <p class="description">Pristine beaches, crystal-clear waters, and luxury overwater
                                        villas await in this tropical paradise destination.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            ...
                            <div class="col-12" data-aos="fade-left" data-aos-delay="300">
                                <div class="compact-destination">
                                    <div class="destination-image">
                                        <img src="{{ asset('customer/img/travel/destination-7.webp') }}"
                                            alt="Mountain Adventure" class="img-fluid">
                                        <div class="badge-offer">Best Value</div>
                                    </div>
                                    <div class="destination-details">
                                        <h4>Mountain Adventure</h4>
                                        <p class="location"><i class="bi bi-geo-alt"></i> Nepal</p>
                                        <p class="brief">Breathtaking Himalayan peaks and ancient Buddhist temples create
                                            an unforgettable spiritual journey.</p>
                                        <div class="stats-row">
                            ...
                            <div class="col-12" data-aos="fade-left" data-aos-delay="400">
                                <div class="compact-destination">
                                    <div class="destination-image">
                                        <img src="{{ asset('customer/img/travel/destination-11.webp') }}"
                                            alt="Cultural Heritage" class="img-fluid">
                                    </div>
                                    <div class="destination-details">
                                        <h4>Cultural Heritage</h4>
                                        <p class="location"><i class="bi bi-geo-alt"></i> Peru</p>
                                        <p class="brief">Discover ancient civilizations, colorful markets, and
                                            archaeological wonders in the heart of South America.</p>
                                        <div class="stats-row">
                            ...
                            <div class="col-12" data-aos="fade-left" data-aos-delay="500">
                                <div class="compact-destination">
                                    <div class="destination-image">
                                        <img src="{{ asset('customer/img/travel/destination-16.webp') }}"
                                            alt="Safari Experience" class="img-fluid">
                                    ...
                                    <div class="destination-details">
                                        ...
                                        <p class="brief">Witness the Big Five and experience the great migration in
                                            Africa's most spectacular wildlife reserves.</p>
                                        <div class="stats-row">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="tour-card">
                            <div class="tour-image">
                                <img src="{{ asset('customer/img/travel/tour-4.webp') }}" alt="Desert Safari"
                                    class="img-fluid" loading="lazy">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('customer/img/person/person-m-9.webp') }}" class="testimonial-img"
                                    alt="">
                                <h3>Saul Goodman</h3>
                                <h4>Ceo &amp; Founder</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('customer/img/person/person-f-5.webp') }}" class="testimonial-img"
                                    alt="">
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('customer/img/person/person-f-12.webp') }}" class="testimonial-img"
                                    alt="">
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('customer/img/person/person-m-12.webp') }}" class="testimonial-img"
                                    alt="">
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('customer/img/person/person-m-13.webp') }}" class="testimonial-img"
                                    alt="">
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                            </div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="hero-content" data-aos="zoom-in" data-aos-delay="200">
                    <div class="content-wrapper">
                        ...
                        <p>Unlock incredible destinations with our specially curated travel packages. From exotic beaches to
                    ...
                    <div class="visual-element">
                        <img src="{{ asset('customer/img/travel/showcase-3.webp') }}" alt="Travel Adventure"
                ...
                <div class="newsletter-section" data-aos="fade-up" data-aos-delay="300">
                    <div class="newsletter-card">
                        ...
                        <form class="php-email-form newsletter-form"
                            action="https://bootstrapmade.com/content/demo/Tour/forms/newsletter.php" method="post">
